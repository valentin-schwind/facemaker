        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var setGrid = function () {
                    ...
                    for (i = 0; i <= smNum; i += 1) {
                        step = Math.floor((normalWidth - offsetLeft*2) / smNum * i);

                        if (step >= normalWidth) {
                            step = normalWidth - 1;
                        }
                        gridHTML += '<span class="irs-grid-pol small" style="margin-left: ' + offsetLeft + 'px; left: ' + step +  'px;"></span>';
                    }
                    for (i = 0; i <= bigNum; i += 1) {
                        step = Math.floor((normalWidth - offsetLeft*2) / bigNum * i);

                        if (step >= normalWidth) {
                            step = normalWidth - 1;
                        }
                        gridHTML += '<span class="irs-grid-pol" style="margin-left: ' + offsetLeft + 'px; left: ' + step +  'px;"></span>';
